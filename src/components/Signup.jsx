      ...
      <div className='border border-gray-400 rounded-lg mt-4 md:p-6 p-6 md:w-[360px] w-full max-w-xs sm:max-w-md'>
        ...
        <div onClick={handleGoogleSignIn}
         className='flex   gap-4 md:gap-6 w-full md:w-80 border border-gray-500 mb-6 py-2 px-3 rounded-full cursor-pointer hover:ring-2 hover:ring-gray-400'>
          ...
          <button className="font-bold text-sm md:text-base">Sign up with Google</button>
        </div>
        
        {/* Login Text */}
        <p className='text-black md:mt-[-8px] mt-[-8px] text-2xl md:text-3xl font-semibold text-center'>Create account</p>
        ...
        <form className="w-full" onSubmit={handleSumbit}>
          ...
          <div className='flex justify-center mt-2 gap-2'>
            <p>Already a user?</p>
            <a href='#' className='underline text-blue-600'>LogIn here</a>
          </div>
          </Link>
        </form>
      </div>
