...
//   // Function to add/remove movie to/from wishlist
...
//   // Function to check if a movie is already in wishlist (to be implemented)
...
//       <img src={`https://image.tmdb.org/t/p/original${movie.poster_path}`} alt='Movie Thumbnail' />
...
//         <div className='absolute inset-0 flex items-center justify-center md:bg-black md:bg-opacity-50'>
