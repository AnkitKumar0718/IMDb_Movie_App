...
const Navbar2 = () => {
  ...
  const handleLogout = async () => {
    try {
      ...
      console.log("Error logging out: ", error); // Handle error if any
    }
  };
      ...
      <div className='relative'>
        ...
        {menuOpen && (
          <div className='absolute top-12 left-0 bg-[#242424] rounded shadow-lg z-10 py-2'>
            ...
            {/* Handle logout here, do not redirect directly to login */}
            <div onClick={handleLogout} className='block px-4 py-2 text-white cursor-pointer hover:bg-gray-600'>
              Logout
            </div>
          </div>
        )}
